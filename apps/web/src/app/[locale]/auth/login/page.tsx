        ...
        {step === "phone" ? (
          <>
            ...
            <button
              ...
              disabled={loading}
              className="mt-6 w-full flex items-center justify-center gap-3 rounded-md border-2 border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
